...
/**
 * @author danbin
 * 设计思路: https://blog.csdn.net/qq_22393017/article/details/59488906
 * 3d滚轮控件
 */
public class WheelView extends View {
    ...
    private boolean isDrawCenterBg;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        //默认大小
        textSize = getResources().getDimensionPixelSize(R.dimen.sp_20);
        ...
        if (attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.WheelView_WheelView_textColorOut, 0xFF999999);
            textColorCenter = a.getColor(R.styleable.WheelView_WheelView_textColorCenter, 0xFFF04144);
            dividerColor = a.getColor(R.styleable.WheelView_WheelView_dividerColor, 0xFFE5E5E5);
            ...
            bgColorCenter = a.getColor(R.styleable.WheelView_WheelView_bgColorCenter, 0xFFf9f9f9);
            a.recycle();
        }
    ...
    private void initPaints() {
        ...
        paintCenterBg.setColor(bgColorCenter);
    ...
    public final int getCurrentItem() {
        ...
        if (isCyclic && (selectedItem < 0 || selectedItem >= adapter.getItemsCount())) {
    ...
    public void setDrawCenterBg(boolean isDrawCenterBg) {
        this.isDrawCenterBg = isDrawCenterBg;
    }
