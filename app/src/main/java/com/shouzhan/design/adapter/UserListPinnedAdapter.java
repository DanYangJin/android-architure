...
/**
 * @author danbin
 * @version UserListPinnedAdapter.java, v 0.1 2019-04-21 下午6:34 danbin
 */
public class UserListPinnedAdapter extends BaseBindingRecyclerViewAdapter<UserListResult>{
    ...
    public boolean isPinnedPosition(int position) {
        ...
        return getItemViewType(position) == UserGenderType.FEMALE;
    }
