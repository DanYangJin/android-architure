...
import com.shouzhan.design.base.BaseBindingRecyclerViewPagingAdapter;
import com.shouzhan.design.ui.user.model.remote.result.UserListResult;

/**
 * @author danbin
 * @version UserListPagingAdapter.java, v 0.1 2019-04-21 下午6:34 danbin
 */
public class UserListPagingAdapter extends BaseBindingRecyclerViewPagingAdapter<UserListResult> {

    @NonNull
    @Override
    public BaseBindingRecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Log.e("Catch", "onCreateViewHolder####");
